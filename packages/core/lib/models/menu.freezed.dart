...
class _$MenuImpl extends _Menu {
  ...
  @override
  String toString() {
    return 'Menu(id: $id, orgId: $orgId, name: $name, isActive: $isActive, createdAt: $createdAt)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, orgId, name, isActive, createdAt);
...
abstract class _Menu extends Menu {
  const factory _Menu(
      ...
      required final DateTime createdAt}) = _$MenuImpl;
